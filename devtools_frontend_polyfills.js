...
// Hacks for DOMRect polyfill
const SVGMatrix = window.DOMMatrix;
// DOMRect polyfill, see: https://raw.githubusercontent.com/jarek-foksa/geometry-polyfill/master/geometry-polyfill.js
...
//   https://github.com/tocharomera/generativecanvas/blob/master/node-canvas/lib/DOMMatrix.js
{
  ...
  class DOMMatrix {
    ...
    transformPoint(point) {
      ...
      return new window.DOMPoint(nx, ny, nz, nw);
    }
