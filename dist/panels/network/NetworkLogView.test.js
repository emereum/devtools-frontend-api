...
describeWithMockConnection('NetworkLogView', () => {
    const tests = (targetFactory) => {
        ...
        function createNetworkLogView(filterBar) {
            ...
            return new Network.NetworkLogView.NetworkLogView(filterBar, document.createElement('div'), Common.Settings.Settings.instance().createSetting('networkLogLargeRows', false));
        }
        const tests = (inScope) => () => {
            beforeEach(() => {
